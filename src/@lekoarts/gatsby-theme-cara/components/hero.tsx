...
import { UpDown, UpDownWide, UpDownWideRight, UpDownWideLeft } from "../styles/animations"
// @ts-ignore
    ...
    <div >
      ...
      <Divider speed={0.2} offset={offset} factor={factor}>
        ...
        <UpDownWideRight>
          ...
          <SVG icon="circle" width={16} color="icon_green" left="70%" top="90%" />
        </UpDownWideRight>
        <UpDownWide>
        ...
        <SVG icon="circle" hiddenMobile width={12} color="icon_darkest" left="50%" top="60%" />
        ...
        <SVG icon="circle" width={32} color="icon_blue" left="96%" top="5%" />
